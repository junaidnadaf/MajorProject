...
def pos(text1, text2):
   ...
   # print(pos_tag(tokens2))
    var1 = pos_tag(tokens1)
    var2 = pos_tag(tokens2)
    count=0
    for i in var1:
        for j in var2:
            if i==j:
...
sentence_pairs=[]
cone = czero = cval1 = cval0 = 0
train=pd.read_csv("/home/sne/Desktop/capstone/pref/train4.csv")
a=[]
...
for sent_pair in sentence_pairs:
	overallsem = 0
	simzero = pos(sent_pair[0],sent_pair[1])
	trusim = similarity(sent_pair[0], sent_pair[1], True)
	overallsem = (simzero + trusim)/2
	print "%s\t%s\t%.3f" % (sent_pair[1],sent_pair[2],overallsem)
	cone=cone+1
	if(overallsem>0.5):
		cval1=cval1+1
...
print "########################################################################################"
print "No of questions with zero"
print czero
print "The similarity within 0.5"
print cval0
print "########################################################################################"

print "No of questions with one"
print cone
print "The similarity above 0.5"
print cval1
print "########################################################################################"
